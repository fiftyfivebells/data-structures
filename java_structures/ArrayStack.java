...
/**
 * This is an implementation of a stack using my own version of the ArrayList as a parent. It
 * provides push/pop/peek/empty, the primary stack operations. This isn't a perfect solution, since
 * my list is not an interface or abstract class, so this class has access to the parent's public
 * methods.
 */
public class ArrayStack<T> extends MyArrayList<T> {

  /**
   * Constructor Calls the parent constructor with the desired class
   *
