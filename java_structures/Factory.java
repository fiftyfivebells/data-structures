...
/**
 * Taken from Pat Morin's book Open Data Structures. This class allows me to instantiate objects and
 * arrays of generic type. It's a workaround for some of the limitations of Java generics.
 */
public class Factory<T> {
  ...
  /**
   * Constructor - creates a factory for creating objects and arrays of type t(=T)
   *
   * @param t0
   */
